<div class="row no-gutters">
  ...
  <div class="col-lg-2 col-md-2 col-sm-1 d-sm-block d-none card shadow" id="sidebar">
    ...
    <nav class="nav flex-column d-sm-none d-md-block d-none ml-3 pt-5 mt-3">
      <a class="font-weight-bold nav-link text-white active" href="<?= base_url('') ?>"><i class="fas px-1 fa-tachometer-alt"></i> Dashboard</a>
      <hr>
      ...
      <hr>
      <a class="font-weight-bold nav-link text-white" href="<?= base_url('ditanggapi') ?>"><i class="fas px-1 fa-map"></i> Ditanggapi</a>
      <hr>
    ...
    <nav class="nav flex-column d-md-none pt-5 mt-3">
      ...
      <div class="dropright">
        ...
        <div class="dropdown-menu">
          <a href="<?= base_url('ditanggapi') ?>" class="dropdown-item">Data Pengaduan Ditanggapi</a>
        </div>
      </div>
      <div class="dropright">
